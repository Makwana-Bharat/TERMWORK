...
<div class="mb-4">
  ...
  <div class="w-full flex justify-between">
    <div id="image-container1" class="relative flex items-center justify-center" style="width: 100px; height: 100px">
    ...
    <div id="image-container2" class="relative flex items-center justify-center" style="width: 200px; height: 100px">
  ...
  <button id="clear-button1" class="relative bottom-28 left-20 mt-2 p-2 text-white bg-red-500 rounded-full hidden" onclick="clearImageSelection(1)">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
    </svg>
  </button>
  <button id="clear-button2" class="relative   mt-2 p-2 text-white bg-red-500 rounded-full hidden" style="float:right;left:10px;bottom:150px" onclick="clearImageSelection(2)">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
    </svg>
  </button>
